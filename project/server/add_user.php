...
//Get the id of the chat and user being added, from request, making sure to sanitize them in order to prevent code injection
...
//initialism the connection to the database, and set it to utf8mb4 mode, which allows it to deal with unicode
