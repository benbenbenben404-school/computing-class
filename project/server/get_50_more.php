...
//Set the time from the request arguments, and the username from session variables, making sure to sanitise them in order to prevent code ingection
$time = filter_input(INPUT_POST,'time', FILTER_SANITIZE_SPECIAL_CHARS);
$chat_id = filter_input(INPUT_POST,'chat_id', FILTER_SANITIZE_SPECIAL_CHARS);


//Setup the xml strucure that will be returned
...
//initialise the connection to the dataabse, and set it to utf8mb4 mode, which allows it to deal with unicode
